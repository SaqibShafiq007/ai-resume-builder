...
function Footer() {
  return (
    <>
      ...
      <div className='bg-black pt-20 px-4 mt-40'>
        <footer className="bg-[#131314] w-full max-w-[1350px] mx-auto text-white pt-8 lg:pt-12 px-4 sm:px-8 md:px-16 lg:px-28 rounded-tl-3xl rounded-tr-3xl overflow-hidden">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-6 gap-8 md:gap-12">
            ...
            <div className="lg:col-span-3 space-y-6">
              {/* Logo Area */}
              <a href="#" className="block flex items-center gap-2">
                <span className="text-xl font-bold tracking-wide">AI-Resume</span>
              </a>
              <p className="text-sm/6 text-neutral-300 max-w-96">
                Create a professional, ATS-friendly resume in minutes. Let our AI handle the formatting and optimization so you can focus on landing your dream job.
              </p>
            ...
            <div className="lg:col-span-3 grid grid-cols-2 md:grid-cols-3 gap-8 md:gap-12 lg:gap-28 items-start">
              {/* Features (Replaced Products) */}
              <div>
                <h3 className="font-medium text-sm mb-4">Features</h3>
                <ul className="space-y-3 text-sm text-neutral-300">
                    <li><a href="#" className="hover:text-neutral-400">AI Optimization</a></li>
                    <li><a href="#" className="hover:text-neutral-400">Resume Templates</a></li>
                    <li><a href="#" className="hover:text-neutral-400">Cover Letters</a></li>
                    <li><a href="#" className="hover:text-neutral-400">ATS Checker</a></li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-3 text-sm text-neutral-300">
                    <li><a href="#" className="hover:text-neutral-400">Resume Examples</a></li>
                    <li><a href="#" className="hover:text-neutral-400">Career Blog</a></li>
                    <li><a href="#" className="hover:text-neutral-400">Interview Tips</a></li>
                    <li><a href="#" className="hover:text-neutral-400">Help Center</a></li>
                </ul>
              </div>
          ...
          {/* Big Glowing Text at the bottom */}
